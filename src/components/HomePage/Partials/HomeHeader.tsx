...
const HomeHeader: React.FC = (): JSX.Element => {
  return (
    <div className='mxlg:items-center flex h-full w-full flex-col items-start justify-center gap-2'>
      <VersionBadge />
      <div className='mxlg:items-center flex flex-col items-start justify-start gap-2'>
